    ...
    <Card className="w-full max-w-md mx-auto border-0 shadow-warm bg-gradient-to-br from-card via-card to-muted/30">
      <CardHeader className="text-center pb-6 relative">
        ...
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2">
          <div className="w-16 h-1 bg-gradient-cultural rounded-full mb-2"></div>
          <div className="w-10 h-1 bg-gradient-cultural rounded-full mx-auto opacity-60"></div>
          <div className="w-6 h-1 bg-gradient-cultural rounded-full mx-auto mt-1 opacity-40"></div>
        </div>
        ...
        <CardDescription className="text-muted-foreground text-base">
          Begin your journey into India's traditional art heritage
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="px-8 pb-8">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div className="text-sm font-medium">Art Enthusiast</div>
              ...
              >
                <Brush className="w-5 h-5 mb-2" />
                <div className="text-sm font-medium">Traditional Artist</div>
          ...
          <Button 
            type="submit" 
            className="w-full h-12 bg-gradient-cultural hover:shadow-warm transition-all duration-300 text-white font-medium text-base mt-6" 
            disabled={loading}
          >
            {loading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
            {loading ? 'Creating Account...' : 'Join the KalaVerse Community'}
          </Button>
        </form>
